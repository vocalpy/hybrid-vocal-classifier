function make_notmat(min_dur,min_int,threshold,sm_win)
%make_notmat
% generates .not.mat files from unlabeled song.
% .not.mat files are at first just temporary files used to extract
...
%
% After the computer classifies the syllables, thoj
% .not.mat files are changed to the label selected by the computer. The
...
while 1
    ...
    save(notmat_fname,'Fs','fname','labels','min_dur','min_int','threshold','sm_win','onsets','offsets')
