...
class TestPredict:
    ...
    def test_predict_knn_yaml(self, tmp_output_dir, configs_path, test_data_dir):
        ...
        knn_predict_config = os.path.join(configs_path,
    ...
    def test_predict_svm_yaml(self, tmp_output_dir, configs_path, test_data_dir):
        # test select with knn classifier and features specified by feature list indices
        svm_predict_config = os.path.join(configs_path,
    ...
    def test_predict_flatwindow_yaml(self, tmp_output_dir, configs_path, test_data_dir):
        # test select with knn classifier and features specified by feature list indices
        flatwindow_predict_config = os.path.join(configs_path,
                                                 'test_predict_flatwindow.config.yml')
        model_meta_file = os.path.join(test_data_dir,
                                       'model_files',
                                       'flatwindow.meta')
        self._yaml_config_run(flatwindow_predict_config, tmp_output_dir, model_meta_file)
